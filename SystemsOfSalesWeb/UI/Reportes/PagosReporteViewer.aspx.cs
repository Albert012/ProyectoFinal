...
{
    public partial class PagosReporteViewer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                ListadoReportViewer.LocalReport.ReportPath = Server.MapPath(@"~\UI\Reportes\PagosReport.rdlc");
                ListadoReportViewer.LocalReport.DataSources.Clear();
                ListadoReportViewer.LocalReport.DataSources.Add(new ReportDataSource("PagosDataSet", cPagos.GetPagos()));
